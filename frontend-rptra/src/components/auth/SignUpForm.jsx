    ...
    <div className="w-full max-w-lg bg-transparent px-4">
        <form className="space-y-5" onSubmit={handleRegister}>
          ...
          <div className="relative">
            ...
            <span onClick={togglePassword} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 cursor-pointer hover:text-gray-600 transition">{showPassword ? EyeSlashIcon : EyeIcon}</span>
          </div>
          ...
          <div className="relative">
            ...
            <span onClick={toggleConfirmPassword} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 cursor-pointer hover:text-gray-600 transition">{showConfirmPassword ? EyeSlashIcon : EyeIcon}</span>
          </div>
